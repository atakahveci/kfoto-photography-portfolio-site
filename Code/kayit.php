            ...
            <div class="card card-signin my-5">
                <div class="card-body">
                    <h1 style="text-align:center">
                        <img src="/Proje/img/logo-img.png" style="width:55px; height:55px; margin-bottom:5px;" alt="">
                    ...
                    <h5 style="text-align:center;color:white; font-size:14px; font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif">Kayıt Ol!</h5>
                        ...
                        <form class="form-signin"  action="vt.php" method="post"  >
                            ...
                            <div class="form-label-group" style="color:white; font-size:15px">
                                <input type="text" name="soyad" placeholder="Soyadınız" required class="inputt">
                            </div>
                            <div class="form-label-group" style="color:white; font-size:15px">
                    ...
                    <p style="text-align:center; color:white;font-size:10px; font-family:'Segoe UI'">Kayıt olarak KFOTO Gizlilik Politikası’nı okuduğunuzu ve kabul ettiğinizi onaylıyorsunuz.</p>
                </div>
            </div>
        </div>
    </div>
