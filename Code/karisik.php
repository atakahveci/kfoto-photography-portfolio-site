...
?>
<!DOCTYPE html>  <!-- karisik.html sayfası -->
<html lang="en">  
  <head>
    <meta charset="UTF-8" />
    ...
    <div class="bg">
      ...
      >
        <div class="normaltext">
          <h2 style="color: #D3F2D2;">Karışık Kategori</h2>
        </div>

        <section class="div12" id="divon" style="margin-bottom: 105px;">
          <div><img src="/Proje/karisikf/1.jpg" width="100%" /></div>
          <div><img src="/Proje/karisikf/2.jpg" width="100%" /></div>
          <div><img src="/Proje/karisikf/3.jpg" width="100%" /></div>
          <div><img src="/Proje/karisikf/4.jpg" width="100%" /></div>
          <div><img src="/Proje/karisikf/5.jpg" width="100%" /></div>
          <div><img src="/Proje/karisikf/6.jpg" width="100%" /></div>
          <div><img src="/Proje/karisikf/7.jpg" width="100%" /></div>
          <div><img src="/Proje/karisikf/8.jpg" width="100%" /></div>
        </section>
      </div>
      <button
        class="btn"
