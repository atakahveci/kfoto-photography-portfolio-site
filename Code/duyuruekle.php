        ...
        <div class="normaltext">
          ...
          <div class="hakdiv" style="margin-bottom: 120px;">
            <p style="margin-bottom:20px">
              Aşağıda bulunan textarea bölgesine duyurunuzu yazabilirsiniz.
            </p>
            ...
            <input type="hidden"  name="id" value=" <?php echo $id ?>">
              <textarea
                style="height: 150px; padding: 15px; margin-bottom:10px;"
                name="duyuru"
                placeholder=" <?php echo $ad; ?> isimli admin tarafından duyuru:"
                required
              ></textarea>

              <center>
              <button type="submit" name="duyuruekle" class="btnn"
                        style="width:25%; text-align:center; font-size:16px;  background-color: rgba(0, 0, 0, 0.2); color:white;" >Ekle</button>
              </center>
