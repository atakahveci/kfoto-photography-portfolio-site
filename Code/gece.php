...
?>
<!DOCTYPE html>  <!-- gece.html sayfası -->
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    ...
    <div class="bg">
      ...
      >
        <div class="normaltext">
          <h2 style="color: #D3F2D2;">Gece Fotoğrafçılığı</h2>
          <p>Şehir: Kocaeli-İzmit</p>
        
        </div>

        <section class="div12" id="divon" style="margin-bottom: 105px;">
          <div><img src="/Proje/gecef/1.jpg" width="100%" /></div>
          <div><img src="/Proje/gecef/2.jpg" width="100%" /></div>
          <div><img src="/Proje/gecef/3.jpg" width="100%" /></div>
          <div><img src="/Proje/gecef/4.jpg" width="100%" /></div>
          <div><img src="/Proje/gecef/5.jpg" width="100%" /></div>
          <div><img src="/Proje/gecef/6.jpg" width="100%" /></div>
          <div><img src="/Proje/gecef/7.jpg" width="100%" /></div>
          <div><img src="/Proje/gecef/8.jpg" width="100%" /></div>
          <div><img src="/Proje/gecef/9.jpg" width="100%" /></div>
          <div><img src="/Proje/gecef/10.jpg" width="100%" /></div>
          <div><img src="/Proje/gecef/11.jpg" width="100%" /></div>
          <div><img src="/Proje/gecef/12.jpg" width="100%" /></div>
        </section>
      </div>
      <button
        class="btn"
